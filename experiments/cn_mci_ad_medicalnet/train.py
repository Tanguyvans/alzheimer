#!/usr/bin/env python3
"""
Training script for MedicalNet 3D ResNet with Transfer Learning
...
from model_resnet3d import resnet10, resnet18, resnet34, resnet50, load_pretrained_weights
...
class Trainer:
    """Trainer for MedicalNet ResNet3D"""
    ...
    def build_model(self):
        """Build ResNet3D model"""
        logger.info("="*80)
        logger.info("BUILDING RESNET3D MODEL")
        logger.info("="*80)
    ...
    def test(self):
        ...
        checkpoint = torch.load(self.checkpoint_dir / 'best.pth', map_location=self.device)
