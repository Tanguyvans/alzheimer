...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/fig_cross_modal_v4_real.png}}
...
\textbf{Interpretability:} Future work could employ feature attribution methods (e.g., SHAP values) to quantify individual clinical feature contributions and identify the most predictive variables.
