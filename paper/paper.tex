...
To understand what the trained model attends to and validate that its decisions rely on clinically-established AD markers, we performed two complementary analyses on the cross-validation checkpoints (seed 42, five folds): (i) tabular feature attention through the FT-Transformer weights, and (ii) spatial brain attention through ViT attention rollout~\cite{abnar2020quantifying}.
