...
A critical issue in AD classification is data leakage. Young et al. \cite{young2025} found that fewer than 20\% of published studies employ external validation, with methodological issues widespread across the field. Yagis et al. \cite{yagis2021} demonstrated that improper splitting inflates accuracy by 25-55\%. Studies with rigorous subject-level splitting report 66-90\% accuracy.
